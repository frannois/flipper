...
dependencies {
  debugImplementation 'com.facebook.flipper:flipper:0.274.0'
  debugImplementation 'com.facebook.soloader:soloader:0.10.5'

  releaseImplementation 'com.facebook.flipper:flipper-noop:0.274.0'
}
```
...
dependencies {
  debugImplementation 'com.facebook.flipper:flipper:0.274.1-SNAPSHOT'
  debugImplementation 'com.facebook.soloader:soloader:0.10.5'

  releaseImplementation 'com.facebook.flipper:flipper-noop:0.274.1-SNAPSHOT'
}
```
